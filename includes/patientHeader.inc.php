			...
			<div class = "container">
				...
				<div class="collapse navbar-collapse" id="collapse1">
					...
					<ul class="nav navbar-nav navbar-right" style = "margin-right:0">
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class = "fa fa-user"></i> <?php echo strtoupper($patientDetails['name'])?> <span class="caret"></span></a>
							<ul class="dropdown-menu">
								<li><a href="patientAppointments.php"><i class = "fa fa-calendar"></i> APPOINTMENTS</a></li>
								<li><a href="patientHome.php"><i class = "fa fa-wechat"></i> CHAT</a></li>
								<li><a href="myPrescriptions.php"><i class = "fa fa-list"></i> PRESCRIPTIONS</a></li>
