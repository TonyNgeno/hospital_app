...
<div class = "container">
	...
	<div class = "row mine">
		<div class= "col-lg-12">
			<div class = "row"><h2 class = "no-print"> PRESCRIPTIONS GIVEN <span class = "pull-right"><button type = "button" class = "btn btn-info no-print" id = "print"> <i class = "glyphicon glyphicon-print"></i> PRINT PRESCRIPTIONS</button></div></h2></div>
			<p><?php echo $msg;?> &nbsp;</p>
			...
			<div class="panel panel-danger">
				<?php
					...
					$query = 'SELECT prescriptions.id,prescriptions.prescription, prescriptions.date,
									 ...
									 WHERE prescriptions.doctorid = ' . $doctorDetails['id'] . '
